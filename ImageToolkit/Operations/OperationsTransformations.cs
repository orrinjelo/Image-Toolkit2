...
namespace ImageToolkit.Operations
{
    public static class OperationsTransformations
    {
        ...
        public static void Scale()
        {
            ...
            using (FormScale fs = new FormScale(x.ImageWidth, x.ImageHeight))
            {
                fs.Show();
            }
        ...
        public static void Rotate()
        {
            ...
            using (FormRotate fr = new FormRotate(x))
            {
                fr.Show();
            }
            return;
        ...
        public static void Crop()
        {
            ...
            using (FormCrop fc = new FormCrop(x))
            {
