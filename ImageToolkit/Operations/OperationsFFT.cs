...
namespace ImageToolkit.Operations
{
    ...
    public static class OperationsFFT
    {
        ...
        public static void FFT(IOperand X = null, bool spawn = true)
        {
            ...
            if (spawn) ((FormStandard)X).CreateSibling(img, "( Magnitude) FFT of " + bmp.ToString(), cimg);
            else
            {
        ...
        public static void HighPass(IOperand x = null, bool spawn = true)
        {
            ...
            Fourier.CImage[] cimg = ((FormStandard)x).CImg;
            FormFFTFilter ff = new FormFFTFilter(FormFFTFilter.Mode.High, cimg, (FormStandard)x, spawn);
            ff.Show();
        }
        ...
        public static void LowPass(IOperand x = null, bool spawn = true)
        {
            ...
            Fourier.CImage[] cimg = ((FormStandard)x).CImg;
            FormFFTFilter ff = new FormFFTFilter(FormFFTFilter.Mode.Low, cimg, (FormStandard)x, spawn);
            ff.Show();
        }
        ...
        public static void BandPass(IOperand x = null, bool spawn = true)
        {
            ...
            Fourier.CImage[] cimg = ((FormStandard)x).CImg;
            FormFFTFilter ff = new FormFFTFilter(FormFFTFilter.Mode.Narrow, cimg, (FormStandard)x, spawn);
            ff.Show();
        }
        ...
        public static void Notch(IOperand x = null, bool spawn = true)
        {
            ...
            Fourier.CImage[] cimg = ((FormStandard)x).CImg;
            FormFFTFilter ff = new FormFFTFilter(FormFFTFilter.Mode.Notch, cimg, (FormStandard)x, spawn);
            ff.Show();
        }
        ...
        public static void ButterworthLow(IOperand x = null, bool spawn = true)
        {
            ...
            Fourier.CImage[] cimg = ((FormStandard)x).CImg;
            FormFFTFilter ff = new FormFFTFilter(FormFFTFilter.Mode.ButterLow, cimg, (FormStandard)x, spawn);
            ff.Show();
        }
        ...
        public static void ButterworthHigh(IOperand x = null, bool spawn = true)
        {
            ...
            Fourier.CImage[] cimg = ((FormStandard)x).CImg;
            FormFFTFilter ff = new FormFFTFilter(FormFFTFilter.Mode.ButterHigh, cimg, (FormStandard)x, spawn);
            ff.Show();
        }
        ...
        public static void ButterworthLow4(IOperand x = null, bool spawn = true)
        {
            ...
            Fourier.CImage[] cimg = ((FormStandard)x).CImg;
            FormFFTFilter ff = new FormFFTFilter(FormFFTFilter.Mode.ButterLow4, cimg, (FormStandard)x, spawn);
            ff.Show();
        }
        ...
        public static void ButterworthHigh4(IOperand x = null, bool spawn = true)
        {
            ...
            Fourier.CImage[] cimg = ((FormStandard)x).CImg;
            FormFFTFilter ff = new FormFFTFilter(FormFFTFilter.Mode.ButterHigh4, cimg, (FormStandard)x, spawn);
            ff.Show();
        }
        ...
        public static void HighPass(IOperand x, bool spawn = true, float radius = 0f)
        {
            ...
            Fourier.CImage[] cimg = new Fourier.CImage[3];
            for (int i = 0; i < 3; i++) cimg[i] = new Fourier.CImage(Normalize.ToFloat(((FormStandard)x).Image)[i], ((FormStandard)x).Image.Height, ((FormStandard)x).Image.Width);
            ...
            if (spawn) x.CreateSibling(img, "High Pass filter of " + ((FormStandard)x).GetBitmap().ToString());
        ...
        public static void LowPass(IOperand x, bool spawn = true, float radius = 0f)
        {
            ...
            if (spawn) x.CreateSibling(img, "Low Pass filter of " + ((FormStandard)x).GetBitmap().ToString());
            else ((FormStandard)x).Image = Normalize.FromFloat(img);
        }
        ...
        public static void BandPass(IOperand x, bool spawn = true, float radius1 = 0f, float radius2 = 0f)
        {
            ...
            if (spawn) x.CreateSibling(img, "Band Pass filter of " + ((FormStandard)x).GetBitmap().ToString());
            else ((FormStandard)x).Image = Normalize.FromFloat(img);
        }
        ...
        public static void Notch(IOperand x, bool spawn = true, float radius1 = 0f, float radius2 = 0f)
        {
            ...
            if (spawn) x.CreateSibling(img, "Notch filter of " + ((FormStandard)x).GetBitmap().ToString());
            else ((FormStandard)x).Image = Normalize.FromFloat(img);
        }
        ...
        public static void ButterworthLow(IOperand x, bool spawn = true, float radius = 0f)
        {
            ...
            if (spawn) x.CreateSibling(img, "Butterworth Low Pass filter of " + ((FormStandard)x).GetBitmap().ToString());
            else ((FormStandard)x).Image = Normalize.FromFloat(img);
        }
        ...
        public static void ButterworthHigh(IOperand x, bool spawn = true, float radius = 0f)
        {
            ...
            if (spawn) x.CreateSibling(img, "Butterworth High Pass filter of " + ((FormStandard)x).GetBitmap().ToString());
            else ((FormStandard)x).Image = Normalize.FromFloat(img);
        }
